...
var messages = {
    'finish': [
        ['STOP! Sorry, no cumshot for you. <br />Try again, maybe you will get lucky next time... Now get your hands off your dick until this is over.', 30, "Unable to Cum"],
        ...
        ['CUM!', 25, "Cumming"],
        ['You have 5 seconds to start cumming, otherwise it\'s game over!', 6, "Cumming Faster than flash"],
        ['You can cum now. GO!', 25,"Cumming"]
    ],
    'stop' : [
        ['STOP TOUCHING! Calm down, be ready for the next one...', 25,"being ready for next instruction"],
    ...
    'go' : [
        ...
        ['Jerk off ONLY the tip, use only TWO FINGERS.', 25,"Playing with penis tip with 2 fingers"],
...
presence.on("UpdateData", () => __awaiter(this, void 0, void 0, function* () {
    if (document.location.pathname == "/") {
        ...
        if (choosen){
            ...
            else if (messages["first"][0]==document.getElementById("message").children[0].innerHTML){
                var elapsed  = Math.floor(Date.now / 1000)
                let presenceData = {
